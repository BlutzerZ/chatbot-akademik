...
const chatData = [
      ...
      },
      {
            id:6,
            sender:'bngky',
            content:'Kamu bisa mendaftar TA melalui situs berikut www.ta.dinus.ac.id. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rerum omnis id earum! Doloribus rerum id explicabo nobis alias maiores, odio velit voluptate beatae quisquam totam odit numquam illum minus quaerat animi unde? Ad amet aspernatur ex suscipit fugit fugiat quia veritatis ullam tenetur dolore tempore, at ducimus est ea modi.',
      },
      {
            id:7,
            sender:'user',
...
export default function ConversationsViewsMobile(){
      ...
      return (
            <>
                  ...
                  <div className={`py-1 fixed mb-16 left-0 top-0 h-screen w-1/2 bg-white z-50 transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
                        {isSidebarOpen && 
                        (
                              <>
                                    <div className="w-full mt-5 shadow-md">
                                          <div className="flex items-center justify-end h-10">
                                                <button onClick={handleSidebar} className="w-fit pr-5">
                                                      <span className="p-2 material-symbols-rounded text-primary-700 hover:bg-primary-50 transition duration-100 rounded-full scale-125">
                                                            chevron_left
                                                      </span>
                                                </button>
                                          </div>
                                    ...
                                    <div className="overflow-y-scroll pb-20 px-3" style={{ height: `calc(100% - 15rem)` }}>
                                    ...
                                    <div className="bg-white fixed bottom-0 h-36 w-full px-3 py-3">
                                          <div className="bg-primary-100 hover:bg-primary-200 text-primary-700 rounded-md transition duration-100">
                                                <button className="rounded-md w-full ">
                                                      <div className="flex justify-center content-center gap-2 py-4">
                                                            ...
                                                            <p className="content-center font-semibold text-lg">Percakapan baru</p>
                                                      </div>
                                                </button>
                                          </div>
                                    </div>
                  ...
                  {isSidebarOpen && (
                        <div onClick={handleSidebar} className="w-screen h-screen bg-black bg-opacity-10 shadow-md fixed z-40 top-0">
                        </div>
                  )}
                  ...
                  <div>
                        ...
                        <div className="mt-24 pb-64 pt-24 px-4">
