...
@router.get("/auth/refresh-token", dependencies=[Depends(JWTBearer())], response_model=response.UserAuthResponse, tags=["User"])
async def refresh_token(
    ...
    return response.UserAuthResponse(code=200, message="Loh valid", data={'token': token})
