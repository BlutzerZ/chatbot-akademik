...
from app.conversation.model import Conversation as ModelConversation, Message as ModelMessage, RoleEnum 
...
class FeedbackService:
    ...
    def get_feedback_by_id(self, jwtData, feedback_id) -> list[Exception ,model.Feedback]:
        try:
            feedback = (
                self.session.query(model.Feedback)
    ...
    def feedback_by_message(self, jwtData, message_id, data) -> list[Exception, model.Feedback]:
        # Get Message
        ...
        if feedback: # Feedback is found
            ...
            try:
                ...
                previous_message = (
                    ...
                    .join(ModelConversation, ModelMessage.conversation_id == ModelConversation.id)
                    .filter(
