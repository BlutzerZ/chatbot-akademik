...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("assistant", "system", "user", name="roleenum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "generation_status",
            sa.Enum("pending", "generating", "stopped", name="generationstatusenum"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("valid", "invalid", "in_review", name="feedbackstatus"),
            nullable=True,
        ),
        sa.Column("deleted_at", sa.DateTime(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=True),
