...
export default function ChatViewsMobile(){
      ...
      return (
            <>
                                          ...
                                          <div className="bg-primary-100 rounded-md">
                                                <button className="hover:bg-primary-50 rounded-md w-full">
                                                      <div className="flex justify-center content-center gap-2 py-4">
                                                            ...
                                                            <p className="content-center font-semibold text-lg text-primary-700">Percakapan baru</p>
                                                      </div>
                                                </button>
                                          </div>
                                    </div>
                  ...
                  {isSidebarOpen && (
                        <div onClick={handleSidebar} className="w-screen h-screen bg-black bg-opacity-5 shadow-md fixed z-40 top-0">
                        </div>
                  )}
